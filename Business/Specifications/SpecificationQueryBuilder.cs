...
namespace Business.Specifications
{
    ...
    {
        public static IQueryable<T> BuildQuery(IQueryable<T> query, Interfaces.Specifications.ISpecification<T> specification)
        {
            // Where
        ...
        /// <returns></returns>
        public static IQueryable<T> BuildCountQuery(IQueryable<T> query, Interfaces.Specifications.ISpecification<T> specification)
        {
        ...
        /// <param name="spec"></param>
        /// <returns></returns>
        public static IQueryable<T> BuildGroupByQuery(IQueryable<T> query, Interfaces.Specifications.ISpecification<T> specification)
        {
            if (specification.Criteria != null)
            {
                query = query.Where(specification.Criteria);
